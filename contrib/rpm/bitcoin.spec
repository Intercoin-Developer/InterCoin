...
issuing of InterCoins is carried out collectively by the network.
...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 17332
...
if [ $1 -eq 0 ]; then
	...
	%{_sbindir}/semanage port -d -p tcp 17332
	for selinuxvariant in %{selinux_variants}; do
