...
find . -name "intercoin*setup.exe" -delete
find . -name "intercoin*setup.asc" -delete

wine "$MAKENSIS" "contrib/windeploy/setup-32.nsi"
wine "$MAKENSIS" "contrib/windeploy/setup-64.nsi"

pkg32="dist/intercoin-${version}-win32-setup"
pkg64="dist/intercoin-${version}-win64-setup"
