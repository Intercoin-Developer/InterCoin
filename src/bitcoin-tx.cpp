...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s intercoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  intercoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded InterCoin transaction") + "\n" +
              "  intercoin-tx [options] -create [commands]   " + _("Create hex-encoded InterCoin transaction") + "\n" +
              "\n";
