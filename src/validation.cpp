...
#if defined(NDEBUG)
# error "InterCoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "InterCoin Signed Message:\n";
...
bool ReadBlockFromDisk(CBlock& block, const CDiskBlockPos& pos, const Consensus::Params& consensusParams)
{
   ...
   // Check the header
  //  if (!CheckProofOfWork(block.GetHashYespower(), block.nBits, consensusParams))
...
static bool CheckBlockHeader(const CBlockHeader& block, CValidationState& state, const Consensus::Params& consensusParams, bool fCheckPOW = true)
{
    ...
    if (fCheckPOW && !CheckProofOfWork(block.GetHashYespower(), block.nBits, consensusParams))
...
static bool ContextualCheckBlock(const CBlock& block, CValidationState& state, const Consensus::Params& consensusParams, const CBlockIndex* pindexPrev)
{
    ...
    if ((nHeight >= consensusParams.BIP34Height) && (nHeight >= 2))
    {
