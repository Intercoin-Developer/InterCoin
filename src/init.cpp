...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/intercoin/intercoin>";
    const std::string URL_WEBSITE = "<https://intercoin.com>";

    return CopyrightHolders(strprintf(_("Copyright (C) %i-%i"), 2009, COPYRIGHT_YEAR) + " ") + "\n" +
           strprintf(_("Copyright (C) %i The InterCoin developers"), COPYRIGHT_YEAR) + "\n" +
           "\n" +
